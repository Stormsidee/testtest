...
# Конфигурация
BOT_TOKEN = "8536434594:AAG3n0tCFBlg5NNEAgviT5IfutQNgolH5SU"
HA_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI1NDg3MGRlYmNjMjE0NDdiYmFkMzBjZTJmNDE3NWY3ZiIsImlhdCI6MTc2NDM5OTg1MCwiZXhwIjoyMDc5NzU5ODUwfQ.yPs9CJV5-vnJMcy-ogoiWVrGjTZaY0VxDFSMLUnpFZU"
HA_URL = "http://37.208.73.212:8123"
...
class OptimizedHomeBot:
    def __init__(self):
        ...
        self._cache_timestamp: Dict[str, float] = {}  # Таймстемп кэша для каждого пространства
    ...
    def shorten_name(self, name: str, area_name: str = "") -> str:
        ...
        clean_name = re.sub(rf'{re.escape(area_name)}', '', name, flags=re.IGNORECASE)
    ...
    def handle_message(self, chat_id: int, text: str) -> None:
        ...
        try:
            ...
            # Обработка команд сброса состояния
            if text_lower in ['/start', 'обновить', 'назад', 'статус всех']:
        ...
        while True:
            try:
                ...
                if result and result.get("ok"):
                    ...
                    if updates:
                        logger.info(f"Сообщений: {len(updates)}")
